              ...
              {sokovi.data.map((restaurant) => (
                ...
                >
                  <button
                    ...
                    class={"" + "button" + restaurant.id}
                    data-id={restaurant.id}
                  >
                    <div
                      class="card product pt-4"
                      data-id={"p" + restaurant.id}
                    >
                      <div class="cover">
                        <img
                          src={
                      ...
                      <div class="card-body border rounded">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-3">
                          ...
                          <span class="font-weight-bold price">
                            {restaurant.attributes.price}
                          </span>
                          <span class="font-weight-bold price">
                            {restaurant.attributes.categories.data.name}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div class="card-body border rounded">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-3">
                          ...
                          <span class="font-weight-bold price">
                            {restaurant.attributes.categories.data.id}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div class="grid-item-recipient" id="grid-item-cart">
              ...
              <div>
                ...
                <div class="billheading">
                  ...
                  <p>NOVI SAD</p>
                  <p>
                    KASIR: <span>{session.user.email}</span>
                  </p>
                  <p>ESIR broj:</p>
                  <p>===========PRODAJA===========</p>
                </div>
...
Home.getInitialProps = async (context) => {
  try {
    ...
    const restaurants = await fetch(
      "http://localhost:1337/api/products?populate=%2A&pagination[page]=1&pagination[pageSize]=20",
      {
        method: "GET",
        headers,
      }
    ...
    const customers = await fetch(
      "http://localhost:1337/api/customers?populate=%2A",
      {
        method: "GET",
        headers,
      }
    ...
    const categories = await fetch(
      "http://localhost:1337/api/categories?populate=%2A",
      {
        method: "GET",
        headers,
      }
    ...
    return { menus, restaurants, categories, customers, sokovi };
  } catch (error) {
    return { error };
  }
};
